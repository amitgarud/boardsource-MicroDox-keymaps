...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_split_3x5_3(
    ...
    KC_Z,              ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,              KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    KC_SLSH,
                              LT(MEDR, KC_ESC),  LT(NAVR, KC_TAB),  LT(MOUR, KC_BSPC),  LT(NSSL, KC_SPC),  LT(NSL, KC_ENT),  LT(FUNL, KC_DEL)
  ),
  ...
  [NAVR] = LAYOUT_split_3x5_3(
    ...
    KC_NA,   KC_ALGR, KC_NA,   KC_NA,   KC_NA,   KC_INS,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,
          KC_NA,   KC_NA,   KC_NA,    KC_SPC,  KC_ENT,  KC_DEL),
  ...
  [FUNL] = LAYOUT_split_3x5_3(
    ...
    KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_PAUS, KC_NA,   KC_NA,   KC_NA,   KC_ALGR, KC_NA,
          KC_APP,  KC_TAB,   KC_SPC,    KC_NA,   KC_NA,   KC_NA),
